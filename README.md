...
<strong>	3.</strong> As CLASSES Curso, Mentoria e Devs também seréo MODELADOS, ou seja, criaremos seus ATRIBUTOS E MÉTODOS <br> 
...
<h2> 📚 Paradigma de Programaçao Orientado a Objetos (POO) </h2>
...
Objeto em ci�ncia da computação, é uma referência a um local da memória que possui um valor. Um objeto pode ser uma variável, função, ou estrutura de dados. 

<h3>🔺 INSTâNCIA: </h3>
Uma instãncia de uma classe é um novo objeto criado dessa classe, com o operador new. Instanciar uma classe é criar um novo objeto do mesmo tipo dessa classe. Uma classe somente poderá ser utilizada após ser instanciada.
